...
def wechsel():
    global spielerin_aktuell
    if spielerin_aktuell == 'X':
        spielerin_aktuell = 'O'
    else:
        spielerin_aktuell = 'X'
...
spielfeld()
print("Die Spielfelder sind von 1 bis 9 durchnummeriert. Spielerin 'X' faengt immer an")
spielmodus= input("Moechtest du gegen den Computer oder eine Person spielen? Gebe 'c' fuer den Computer und 'p' sonst ein.")
while spiel_aktiv:
    # Eingabe des aktiven Spielers
    print()
    print ("Spieler " + spielerin_aktuell + " am Zug")
    spielfeld_KI = []
    ...
    if spielerin_aktuell=='O' and spielmodus=='c':
        spielzug = int(random.choice(spielfeld_KI))
        if spielzug:
        # spielfeld[spielzug] = 'X'
            spielfeld[spielzug] = spielerin_aktuell
        # aktuelles Spielfeld ausgeben
            spielfeld()
       ...
       # Spieler wechseln
        ...
        spielzug = spielerin_wahl()
        print(spielerin_aktuell)
        if spielzug:
        # spielfeld[spielzug] = 'X'
            spielfeld[spielzug] = spielerin_aktuell
        # aktuelles Spielfeld ausgeben
       ...
       # Spieler wechseln
            ...
            print("Ungueltige Eingabe. Starte das Spiel erneut")
print() 
